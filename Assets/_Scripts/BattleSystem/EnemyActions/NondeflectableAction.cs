...
public class NondeflectableAction : EnemyAction, IAttackRequester
{
    ...
    [Header("Nondeflectable Animations")]
    ...
    private NondeflectNode _currNode;
    ...
    public void Slash(NondeflectNode node)
    {
    ...
    private IEnumerator SlashThread(NondeflectNode node)
    {
    ...
    {
        return false; //not blockable so always return false
        /*
    ...
    {
        return false; //not deflectable so always return false
        /*
        PlayerBattlePawn player = receiver as PlayerBattlePawn;
        if (player == null
