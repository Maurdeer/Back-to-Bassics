...
public class FileDataHandler
{
    ...
    private readonly string encryptionCodeWord = "vgdev";
    ...
    public GameData Load(string profileId, bool allowRestoreFromBackup = true)
    {
        ...
        //use Path.Combine to account for different path separators
    ...
    public void Save(GameData data, string profileId)
    {
        ...
        //using Path.Combine to account for different path separators
        string fullPath = Path.Combine(dataDirPath, profileId, dataFileName);
        ...
        try
        {
            ...
            // otherwise, throw an exception because something went wrong
            else
            {
